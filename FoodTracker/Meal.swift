...
//  FoodTracker
//
//  Created by Kenta Terada on 2020/03/28.
...
class Meal: NSObject, NSSecureCoding {
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        let photo: UIImage? = aDecoder.decodeObject(forKey: PropertyKey.photo) as? UIImage
        let rating: Int = aDecoder.decodeInteger(forKey: PropertyKey.rating)
