...
//  FoodTracker
//
//  Created by Kenta Terada on 2020/03/31.
...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    private func loadSampleMeals() {
        let photo1: UIImage = #imageLiteral(resourceName: "meal1")
        let photo2: UIImage = #imageLiteral(resourceName: "meal2")
        let photo3: UIImage = #imageLiteral(resourceName: "meal3")
    ...
    private func saveMeals() {
        ...
        do {
            ...
            os_log("Meals successfully saved.", log: OSLog.default, type: OSLogType.debug)
        }
        catch {
            os_log("Failed to save meals...", log: OSLog.default, type: OSLogType.error)
        }
    }
    ...
    private func loadMeals() -> [Meal]? {
        do {
            ...
            if let loadedData = try NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(data) as? [Meal] {
                os_log("Meals successfully loaded.", log: OSLog.default, type: OSLogType.debug)
                return loadedData
            }
        }
        catch {
            os_log("Failed to load meals...", log: OSLog.default, type: OSLogType.error)
        }
        return nil
    }
